...
# Для площадок с собственным порталом — прямой URL.
# Для компаний без отдельного портала — ЕИС с фильтром по organizationName.
CORPORATE_SOURCES = [
    # ── Банки и финансы ───────────────────────────────────────────────────────
    {'key': 'sber',      'name': 'Сбербанк',       'icon': '🟢',
     'search_url': 'https://zakupki.sberbank.ru/223/purchaseList/page/1?searchText={query}',
     'api_url': None, 'type': 'corporate', 'group': 'Банки'},
    {'key': 'vtb',       'name': 'ВТБ',             'icon': '🏦',
     'search_url': 'https://www.zakupki.gov.ru/epz/order/extendedsearch/results.html?searchString={query}&organizationName=%D0%92%D0%A2%D0%91&morphology=on&fz223=on',
     'api_url': None, 'type': 'corporate', 'group': 'Банки'},

    # ── Нефть и газ ───────────────────────────────────────────────────────────
    {'key': 'gazprom',   'name': 'Газпром',         'icon': '🔵',
     'search_url': 'https://pgz.gazprom.ru/purchase/?search={query}',
     'api_url': None, 'type': 'corporate', 'group': 'Нефть и газ'},
    {'key': 'rosneft',   'name': 'Роснефть',        'icon': '⚡',
     'search_url': 'https://purchase.rosneft.ru/lots?keyword={query}',
     'api_url': None, 'type': 'corporate', 'group': 'Нефть и газ'},
    {'key': 'lukoil',    'name': 'Лукойл',          'icon': '🛢️',
     'search_url': 'https://zakupki.gov.ru/epz/order/extendedsearch/results.html?searchString={query}&organizationName=%D0%9B%D1%83%D0%BA%D0%BE%D0%B9%D0%BB&morphology=on&fz223=on',
     'api_url': None, 'type': 'corporate', 'group': 'Нефть и газ'},
    {'key': 'gazprom_bur', 'name': 'Газпром Бурение', 'icon': '⛏️',
     'search_url': 'https://zakupki.gov.ru/epz/order/extendedsearch/results.html?searchString={query}&organizationName=%D0%93%D0%B0%D0%B7%D0%BF%D1%80%D0%BE%D0%BC+%D0%91%D1%83%D1%80%D0%B5%D0%BD%D0%B8%D0%B5&morphology=on&fz223=on',
     'api_url': None, 'type': 'corporate', 'group': 'Нефть и газ'},
    {'key': 'transneft', 'name': 'Транснефть',      'icon': '🔧',
     'search_url': 'https://zakupki.gov.ru/epz/order/extendedsearch/results.html?searchString={query}&organizationName=%D0%A2%D1%80%D0%B0%D0%BD%D1%81%D0%BD%D0%B5%D1%84%D1%82%D1%8C&morphology=on&fz223=on',
     'api_url': None, 'type': 'corporate', 'group': 'Нефть и газ'},
    {'key': 'novatek',   'name': 'НОВАТЭК',         'icon': '🌊',
     'search_url': 'https://zakupki.gov.ru/epz/order/extendedsearch/results.html?searchString={query}&organizationName=%D0%9D%D0%9E%D0%92%D0%90%D0%A2%D0%AD%D0%9A&morphology=on&fz223=on',
     'api_url': None, 'type': 'corporate', 'group': 'Нефть и газ'},
    {'key': 'russneft',  'name': 'Русснефть',       'icon': '🏭',
     'search_url': 'https://zakupki.gov.ru/epz/order/extendedsearch/results.html?searchString={query}&organizationName=%D0%A0%D1%83%D1%81%D1%81%D0%BD%D0%B5%D1%84%D1%82%D1%8C&morphology=on&fz223=on',
     'api_url': None, 'type': 'corporate', 'group': 'Нефть и газ'},
    {'key': 'surgutneft', 'name': 'Сургутнефтегаз', 'icon': '🛤️',
     'search_url': 'https://zakupki.gov.ru/epz/order/extendedsearch/results.html?searchString={query}&organizationName=%D0%A1%D1%83%D1%80%D0%B3%D1%83%D1%82%D0%BD%D0%B5%D1%84%D1%82%D0%B5%D0%B3%D0%B0%D0%B7&morphology=on&fz223=on',
     'api_url': None, 'type': 'corporate', 'group': 'Нефть и газ'},
    {'key': 'tatneft',   'name': 'Татнефть',        'icon': '🔶',
     'search_url': 'https://zakupki.gov.ru/epz/order/extendedsearch/results.html?searchString={query}&organizationName=%D0%A2%D0%B0%D1%82%D0%BD%D0%B5%D1%84%D1%82%D1%8C&morphology=on&fz223=on',
     'api_url': None, 'type': 'corporate', 'group': 'Нефть и газ'},
    {'key': 'sibur',     'name': 'СИБУР',           'icon': '🧪',
     'search_url': 'https://b2b.sibur.ru/tenders/?search={query}',
     'api_url': None, 'type': 'corporate', 'group': 'Нефть и газ'},
    ...
    {'key': 'rosatom',   'name': 'Росатом',         'icon': '⚛️',
     ...
     'api_url': None, 'type': 'corporate', 'group': 'Госкорпорации'},
    {'key': 'rzd',       'name': 'РЖД',             'icon': '🚂',
     'search_url': 'https://zakupki.rzd.ru/item/index?searchString={query}',
     'api_url': None, 'type': 'corporate', 'group': 'Госкорпорации'},
    {'key': 'pochta',    'name': 'Почта России',    'icon': '📮',
     'search_url': 'https://zakupki.gov.ru/epz/order/extendedsearch/results.html?searchString={query}&organizationName=%D0%9F%D0%BE%D1%87%D1%82%D0%B0+%D0%A0%D0%BE%D1%81%D1%81%D0%B8%D0%B8&morphology=on&fz223=on',
     'api_url': None, 'type': 'corporate', 'group': 'Госкорпорации'},
    {'key': 'rosnano',   'name': 'РОСНАНО',         'icon': '🔬',
     'search_url': 'https://zakupki.gov.ru/epz/order/extendedsearch/results.html?searchString={query}&organizationName=%D0%A0%D0%9E%D0%A1%D0%9D%D0%90%D0%9D%D0%9E&morphology=on&fz223=on',
     'api_url': None, 'type': 'corporate', 'group': 'Госкорпорации'},
    {'key': 'skolkovo',  'name': 'Сколково',        'icon': '🏗️',
     'search_url': 'https://zakupki.gov.ru/epz/order/extendedsearch/results.html?searchString={query}&organizationName=%D0%A1%D0%BA%D0%BE%D0%BB%D0%BA%D0%BE%D0%B2%D0%BE&morphology=on&fz223=on',
     'api_url': None, 'type': 'corporate', 'group': 'Госкорпорации'},
    {'key': 'rosavtodor', 'name': 'Росавтодор',    'icon': '🛣️',
     'search_url': 'https://zakupki.gov.ru/epz/order/extendedsearch/results.html?searchString={query}&organizationName=%D0%A0%D0%BE%D1%81%D0%B0%D0%B2%D1%82%D0%BE%D0%B4%D0%BE%D1%80&morphology=on&fz223=on',
     'api_url': None, 'type': 'corporate', 'group': 'Госкорпорации'},
    {'key': 'avtodor',   'name': 'Автодор',         'icon': '🚗',
     'search_url': 'https://zakupki.gov.ru/epz/order/extendedsearch/results.html?searchString={query}&organizationName=%D0%90%D0%B2%D1%82%D0%BE%D0%B4%D0%BE%D1%80&morphology=on&fz223=on',
     'api_url': None, 'type': 'corporate', 'group': 'Госкорпорации'},
    {'key': 'alrosa',    'name': 'АЛРОСА',          'icon': '💎',
     'search_url': 'https://zakupki.gov.ru/epz/order/extendedsearch/results.html?searchString={query}&organizationName=%D0%90%D0%9B%D0%A0%D0%9E%D0%A1%D0%90&morphology=on&fz223=on',
     'api_url': None, 'type': 'corporate', 'group': 'Госкорпорации'},

    # ── Металлургия и промышленность ──────────────────────────────────────────
    {'key': 'evraz',     'name': 'ЕВРАЗ',           'icon': '🏗️',
     'search_url': 'https://zakupki.gov.ru/epz/order/extendedsearch/results.html?searchString={query}&organizationName=%D0%95%D0%92%D0%A0%D0%90%D0%97&morphology=on&fz223=on',
     'api_url': None, 'type': 'corporate', 'group': 'Промышленность'},
    {'key': 'rusal',     'name': 'РУСАЛ',           'icon': '⚙️',
     'search_url': 'https://zakupki.gov.ru/epz/order/extendedsearch/results.html?searchString={query}&organizationName=%D0%A0%D0%A3%D0%A1%D0%90%D0%9B&morphology=on&fz223=on',
     'api_url': None, 'type': 'corporate', 'group': 'Промышленность'},
    {'key': 'severstal', 'name': 'Северсталь',      'icon': '🔩',
     'search_url': 'https://zakupki.gov.ru/epz/order/extendedsearch/results.html?searchString={query}&organizationName=%D0%A1%D0%B5%D0%B2%D0%B5%D1%80%D1%81%D1%82%D0%B0%D0%BB%D1%8C&morphology=on&fz223=on',
     'api_url': None, 'type': 'corporate', 'group': 'Промышленность'},
    {'key': 'kamaz',     'name': 'КАМАЗ',           'icon': '🚛',
     'search_url': 'https://zakupki.gov.ru/epz/order/extendedsearch/results.html?searchString={query}&organizationName=%D0%9A%D0%90%D0%9C%D0%90%D0%97&morphology=on&fz223=on',
     'api_url': None, 'type': 'corporate', 'group': 'Промышленность'},
    {'key': 'avtovaz',   'name': 'АвтоВАЗ',        'icon': '🚙',
     'search_url': 'https://zakupki.gov.ru/epz/order/extendedsearch/results.html?searchString={query}&organizationName=%D0%90%D0%B2%D1%82%D0%BE%D0%92%D0%90%D0%97&morphology=on&fz223=on',
     'api_url': None, 'type': 'corporate', 'group': 'Промышленность'},
    {'key': 'avtotour',  'name': 'АВТОТОР',         'icon': '🏎️',
     'search_url': 'https://zakupki.gov.ru/epz/order/extendedsearch/results.html?searchString={query}&organizationName=%D0%90%D0%92%D0%A2%D0%9E%D0%A2%D0%9E%D0%A0&morphology=on&fz223=on',
     'api_url': None, 'type': 'corporate', 'group': 'Промышленность'},
    {'key': 'gaz_group', 'name': 'Группа ГАЗ',     'icon': '🚌',
     'search_url': 'https://zakupki.gov.ru/epz/order/extendedsearch/results.html?searchString={query}&organizationName=%D0%93%D1%80%D1%83%D0%BF%D0%BF%D0%B0+%D0%93%D0%90%D0%97&morphology=on&fz223=on',
     'api_url': None, 'type': 'corporate', 'group': 'Промышленность'},

    # ── Телеком и технологии ──────────────────────────────────────────────────
    {'key': 'rostelecom', 'name': 'Ростелеком',    'icon': '📡',
     'search_url': 'https://zakupki.rostelecom.ru/purchases/?query={query}',
     'api_url': None, 'type': 'corporate', 'group': 'Телеком'},
    {'key': 'mts',       'name': 'МТС',             'icon': '📱',
     'search_url': 'https://zakupki.gov.ru/epz/order/extendedsearch/results.html?searchString={query}&organizationName=%D0%9C%D0%A2%D0%A1&morphology=on&fz223=on',
     'api_url': None, 'type': 'corporate', 'group': 'Телеком'},
    {'key': 'beeline',   'name': 'Билайн (ВымпелКом)', 'icon': '🐝',
     'search_url': 'https://zakupki.gov.ru/epz/order/extendedsearch/results.html?searchString={query}&organizationName=%D0%92%D1%8B%D0%BC%D0%BF%D0%B5%D0%BB%D0%9A%D0%BE%D0%BC&morphology=on&fz223=on',
     'api_url': None, 'type': 'corporate', 'group': 'Телеком'},
    {'key': 'megafon',   'name': 'МегаФон',         'icon': '📶',
     'search_url': 'https://zakupki.gov.ru/epz/order/extendedsearch/results.html?searchString={query}&organizationName=%D0%9C%D0%B5%D0%B3%D0%B0%D0%A4%D0%BE%D0%BD&morphology=on&fz223=on',
     'api_url': None, 'type': 'corporate', 'group': 'Телеком'},
    ...
    {'key': 'mail',      'name': 'VK / Mail.ru',    'icon': '💙',
     ...
     'api_url': None, 'type': 'corporate', 'group': 'Телеком'},
    {'key': 'afk',       'name': 'АФК Система',     'icon': '🏢',
     'search_url': 'https://zakupki.gov.ru/epz/order/extendedsearch/results.html?searchString={query}&organizationName=%D0%90%D0%A4%D0%9A+%D0%A1%D0%B8%D1%81%D1%82%D0%B5%D0%BC%D0%B0&morphology=on&fz223=on',
     'api_url': None, 'type': 'corporate', 'group': 'Телеком'},

    # ── Ритейл и FMCG ─────────────────────────────────────────────────────────
    {'key': 'magnit',    'name': 'Магнит',           'icon': '🛒',
     'search_url': 'https://magnit.ru/vendors/tenders/',
     'api_url': None, 'type': 'corporate', 'group': 'Ритейл'},
    {'key': 'euroset',   'name': 'Евросеть',        'icon': '📞',
     'search_url': 'https://zakupki.gov.ru/epz/order/extendedsearch/results.html?searchString={query}&organizationName=%D0%95%D0%B2%D1%80%D0%BE%D1%81%D0%B5%D1%82%D1%8C&morphology=on&fz223=on',
     'api_url': None, 'type': 'corporate', 'group': 'Ритейл'},
    {'key': 'eldorado',  'name': 'Эльдорадо',       'icon': '🏪',
     'search_url': 'https://zakupki.gov.ru/epz/order/extendedsearch/results.html?searchString={query}&organizationName=%D0%AD%D0%BB%D1%8C%D0%B4%D0%BE%D1%80%D0%B0%D0%B4%D0%BE&morphology=on&fz223=on',
     'api_url': None, 'type': 'corporate', 'group': 'Ритейл'},
    {'key': 'megapolis',  'name': 'Группа Мегаполис', 'icon': '🏙️',
     'search_url': 'https://zakupki.gov.ru/epz/order/extendedsearch/results.html?searchString={query}&organizationName=%D0%9C%D0%B5%D0%B3%D0%B0%D0%BF%D0%BE%D0%BB%D0%B8%D1%81&morphology=on&fz223=on',
     'api_url': None, 'type': 'corporate', 'group': 'Ритейл'},
    {'key': 'baltika',   'name': 'Балтика',          'icon': '🍺',
     'search_url': 'https://zakupki.gov.ru/epz/order/extendedsearch/results.html?searchString={query}&organizationName=%D0%91%D0%B0%D0%BB%D1%82%D0%B8%D0%BA%D0%B0&morphology=on&fz223=on',
     'api_url': None, 'type': 'corporate', 'group': 'Ритейл'},

    # ── СберТех (устаревший, оставляем для совместимости) ─────────────────────
