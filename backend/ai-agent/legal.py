...
DOC_TYPES = {
    ...
    'calculation': 'Контррасчёт неустойки и процентов по ключевой ставке Банка России',
    'expenses': 'Заявление о взыскании судебных расходов и распределении государственной пошлины',
