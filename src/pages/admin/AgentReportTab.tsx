...
import { Report, StrategyReport, VERDICT_COLOR, TIMING_COLOR } from "./AgentTypes";
...
export default function AgentReportTab({ loading, report, error, onGenerate }: Props) {
  const [activeTab, setActiveTab] = useState<"strategy" | "leads">("strategy");
  const [expandedLead, setExpandedLead] = useState<number | null>(null);

  const s: StrategyReport | undefined = report?.strategy;
